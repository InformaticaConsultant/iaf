...
/* var findSlide = function (slideList, matcher) {
 ...
 var findSlide = function (slideList, matcher) {
    // Reemplazo de _.matcher
    var slideMatch = function (slide) {
        return Object.entries(matcher).every(([key, value]) => slide[key] === value);
    };

    // Reemplazo de _.find
    return slideList.find(slideMatch);
};
Fullscreen.include({
...
patch(SlideUnsubscribeDialog.prototype, {
